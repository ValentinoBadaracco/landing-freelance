...
export default function Projects() {
  return (
    ...
    <section id="projects" className="flex w-full flex-col items-center gap-10 px-6 py-24 text-center sm:px-16 bg-primary-100">
      <h1 className="text-2xl font-semibold leading-tight tracking-tight text-primary-950 dark:text-zinc-50 sm:text-4xl">
        Proyectos de diseño y desarrollo web realizados
      </h1>
      <div className="grid w-full max-w-6xl grid-cols-1 gap-6 sm:grid-cols-3">
        <motion.div
          className="min-h-72 flex flex-col gap-5 rounded-lg bg-primary-50 shadow-lg"
